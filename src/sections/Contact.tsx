        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <motion.div variants={stagger} initial="hidden" animate={inView ? "show" : "hidden"}
            ...
            <motion.p variants={fadeUp} className="text-[#8b949e] leading-relaxed">
              Estou aberto a novas oportunidades, colaborações ou apenas um bate-papo técnico.
          ...
          <motion.div variants={stagger} initial="hidden" animate={inView ? "show" : "hidden"}>
            {status === "sent" ? (
              <motion.div variants={fadeUp}
                ...
                <h3 className="font-bold text-white text-lg mb-2">Mensagem enviada!</h3>
                <p className="text-[#8b949e] text-sm">Obrigado pelo contato. Retornarei em breve.</p>
              ...
              <motion.form onSubmit={handleSubmit} variants={stagger}
                ...
                <motion.div variants={fadeUp}>
                  <label className="block font-mono text-xs text-[#4d5866] uppercase tracking-[0.1em] mb-2">Mensagem</label>
                  <textarea
                    name="message"
                    value={form.message}
                    onChange={handleChange}
                    ...
                    placeholder="Olá Benjamin, gostaria de conversar sobre..."
                  />
                </motion.div>
