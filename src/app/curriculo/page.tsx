...
const t = {
  ...
  en: {
    ...
    skills: [
      ...
      { cat: "Backend (support)", items: "Node.js · REST APIs · MySQL · WebSocket · API Integration · PHP · Framework Laravel" },
        { cat: "Test", items: "Jest · React Testing Library (basic) · PHPUnit" },
        { cat: "Cloud", items: "MS Azure (basic)" },
  ...
  es: {
    ...
    skills: [
      ...
      { cat: "Backend (soporte)", items: "Node.js · REST APIs · MySQL · WebSocket · Consumo de APIs · PHP · Framework Laravel" },
        { cat: "Test", items: "Jest · React Testing Library (básico) · PHPUnit" },
        { cat: "Cloud", items: "MS Azure (básico)" },
