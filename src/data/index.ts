...
export const personal = {
  ...
  linkedin:  "https://www.linkedin.com/in/benjamin-maciel-dev",
  instagram: "https://www.instagram.com/benjamin_maciel_",
  // wa.me rejects punctuation — digits only, country code included.
  ...
  stack: ["React", "TypeScript", "Next.js", "Node.js", "Express", "Prisma", "PostgreSQL", "Tailwind"],
  stats: [
...
export const timeline = [
  ...
  },
  {
    ...
    description: "Entrada no curso técnico de TI no UNASP — São Paulo, Brasil. Já programava ao entrar — se destacou em desenvolvimento web e design nas notas mais altas da turma.",
    current: false,
  ...
  },
  {
    ...
    current: true,
    tech: ["React", "Node.js", "Prisma", "PostgreSQL", "Firebase"],
  },
];
...
export const skills = {
  ...
  backend: [
    { name: "Node.js",    level: 75, desc: "Express REST APIs, JWT auth & server-side business rules" },
    { name: "PostgreSQL", level: 78, desc: "Relational modeling via Prisma; live production database on Neon" },
    { name: "Prisma ORM",  level: 76, desc: "Schema-first modeling, migrations & transactional writes" },
...
export const projects = [
  {
    ...
    featured: true,
    preview: [
      "// routes/movements.js — entrada, saída e ajuste",
      ...
      "",
      "  if (nextStock < 0) return res.status(400).json({",
      "    ok: false, error: 'Estoque não pode ficar negativo',",
      "  });",
      "",
      "  // o registro e o saldo mudam juntos, ou nenhum muda",
      "  const [movement] = await prisma.$transaction([",
      "    prisma.movement.create({ data: { productId, type,",
      "      quantity: q, userId: req.user?.id ?? null } }),",
  ...
  },
  {
    ...
    metrics: [
      ...
      { value: "181+",  label: "Exercícios catalogados" },
    ],
...
export const education = [
  {
    ...
    institution: "UNASP — São Paulo, Brasil",
